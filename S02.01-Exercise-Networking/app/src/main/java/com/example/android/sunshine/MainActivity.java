...
public class MainActivity extends AppCompatActivity {
    ...
    protected void loadWeatherData (String location){
        String userLocation;
        userLocation=getPreferredWeatherLocation(this);
    ...
    public class weatherQueryTask extends AsyncTask<String, Void , String>{
        ...
        protected String doInBackground(String ... params){
            ...
            URL weatherRequestUrl = NetworkUtils.buildUrl(locationParam);
            String githubSearchResults= null;
            try{
                githubSearchResults= getResponseFromHttpUrl(weatherRequestUrl);
        ...
        protected void onPostExecute(String githubSearchResults){
            mWeatherTextView.setText(githubSearchResults);
