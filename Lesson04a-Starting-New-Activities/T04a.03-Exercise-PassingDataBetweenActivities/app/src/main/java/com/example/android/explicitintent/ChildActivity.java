...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent childActivityIntent = getIntent();


        // TODO (4) Create an if statement to check if this Intent has the extra we passed from MainActivity
        Bundle extras = childActivityIntent.getExtras();
        if (childActivityIntent.hasExtra("entryText")) {
            String textFromIntent = extras.getString("entryText");
            mDisplayText.setText(textFromIntent);
